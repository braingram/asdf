...
from . import helpers
from .objects import CustomExtension
...
def fractiontype_factory():
    with pytest.warns(
        ...
        match=r"FractionType from .* subclasses the deprecated CustomType class.*",
    ):
...
def fractional2dcoordtype_factory():
    ...
    with pytest.warns(
        AsdfCustomTypeDeprecationWarning,
        match=r"Fractional2dCoordType from .* subclasses the deprecated CustomType class.*",
    ):
...
def test_version_mismatch_with_supported_versions(custom_test_type):
    ...
    with pytest.warns(
        AsdfCustomTypeDeprecationWarning,
        match=r"CustomFlowType from .* subclasses the deprecated CustomType class.*",
    ):

        class CustomFlowType(custom_test_type):
            version = "1.1.0"
...
def test_versioned_writing(monkeypatch):
    ...
    with pytest.warns(
        AsdfCustomTypeDeprecationWarning,
        match=r"FancyComplexType from .* subclasses the deprecated CustomType class.*",
    ):
...
def test_module_versioning():
    with pytest.warns(
        AsdfCustomTypeDeprecationWarning,
        match=r"NoModuleType from .* subclasses the deprecated CustomType class.*",
    ):
    ...
    with pytest.warns(
        AsdfCustomTypeDeprecationWarning,
        match=r"HasCorrectPytest from .* subclasses the deprecated CustomType class.*",
    ):
    ...
    with pytest.warns(
        AsdfCustomTypeDeprecationWarning,
        match=r"DoesntHaveCorrectPytest from .* subclasses the deprecated CustomType class.*",
    ):
...
def test_incompatible_version_check():
    with pytest.warns(
        AsdfCustomTypeDeprecationWarning,
        match=r"TestType0 from .* subclasses the deprecated CustomType class.*",
    ):
    ...
    with pytest.warns(
        AsdfCustomTypeDeprecationWarning,
        match=r"TestType1 from .* subclasses the deprecated CustomType class.*",
    ):
    ...
    with pytest.warns(
        AsdfCustomTypeDeprecationWarning,
        match=r"TestType2 from .* subclasses the deprecated CustomType class.*",
    ):
    ...
    with pytest.warns(
        AsdfCustomTypeDeprecationWarning,
        match=r"TestType3 from .* subclasses the deprecated CustomType class.*",
    ):
    ...
    with pytest.warns(
        AsdfCustomTypeDeprecationWarning,
        match=r"TestType4 from .* subclasses the deprecated CustomType class.*",
    ):
    ...
    with pytest.warns(
        AsdfCustomTypeDeprecationWarning,
        match=r"TestType5 from .* subclasses the deprecated CustomType class.*",
    ):
    ...
    with pytest.raises(ValueError), pytest.warns(
        AsdfCustomTypeDeprecationWarning,
        match=r"TestType6 from .* subclasses the deprecated CustomType class.*",
    ):
    ...
    with pytest.raises(ValueError), pytest.warns(
        AsdfCustomTypeDeprecationWarning,
        match=r"TestType7 from .* subclasses the deprecated CustomType class.*",
    ):
...
def test_custom_reference_cycle(tmp_path):
    ...
    with pytest.warns(
        AsdfCustomTypeDeprecationWarning,
        match=r"FractionWithInverseType from .* subclasses the deprecated CustomType class.*",
    ):
